			...
			<div id="report_detail" style="width:100%; /*height:200px;*/ float:none; overflow:hidden;">
					<table style="width:100%; border: 1px solid black;">
						...
						<tr>
							...
							<td align="center" style="width:20%;">ร้านค้า</td>
							<td align="center" style="width:10%;">ยอดเต็ม</td>
							<th align="center" style="width:10%;">คงเหลือ</th>
							<th align="center" style="width:10%;">ครบดิว</th>
							<td align="center" style="width:10%;">วันที่</td>
						</tr>
						...
						?>
								...
								<tr>
									...
									<td align="center"><?php echo $row_duedate['po_credit_due_date'];?></td>
