...
<?php 
		...
		$result_po = mysql_query("SELECT p.po_id, p.po_name, tt.to_typename, p.po_shop,  p.po_qty, p.po_price, p.po_date FROM tb_po p JOIN tb_tools_type tt ON tt.to_typeid = p.po_cate WHERE po_cate = '$typeid' AND p.po_date LIKE '$date'");
			...
			<div id="report_detail" style="width:100%; /*height:200px;*/ float:none; overflow:hidden;">
					<table style="width:100%; border: 1px solid black;">
						...
						<tr>
							...
							<td align="center" style="width:35%;">รายการ</td>
