...
<?php 
	...
	if($po_credit == 1 && $po_creditcomp == 1){
	...
	if($result1){ 
		if($po_credit == 1 && $po_creditcomp == 1){ // ต้องติ๊กชำระ เครดิตเท่านั้น ถึงจะมี Transaction ในตาราง tb_cash_center
			$temp_cash1 = $cash1 - $poprice;
			$cal_cash = "INSERT INTO tb_cash_center SET cash_po = '$po_id', cash_out = '$poprice', cash_date = '$podate', cash_now = '$cash_now', cash_times = now(), cash1 = '$temp_cash1', cash2 = '$cash2', cash_emp = '$cash_emp', cash_temp = '$cash_temp'";		
