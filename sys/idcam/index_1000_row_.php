<?php session_start(); 
	...
	if($velas == '720'){
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no LIMIT 720";
	}else if($velas == '1440'){
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no LIMIT 1440";
	}
	else if($velas == '10080'){
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no LIMIT 10080";
	}
	else if($velas == '40320'){
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no LIMIT 40320";
	}
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" >ห้องเย็นไอศรีมละมุน  <?php echo $TTemp;?>C<sup>o</sup></a>
            </div>
