...
echo "<META HTTP-EQUIV='Refresh' CONTENT = '300;'>";	
	...
	$sql="SELECT * FROM datalogger WHERE chipid = '$mac' ORDER BY no DESC LIMIT 20  "; //WHERE chipid LIKE $search 
	
	$Csql="SELECT * FROM register WHERE chipid = '$mac'  "; //WHERE chipid LIKE $search 
	  ...
	  while($row = mysqli_fetch_array($result))
		{
		 ...
		 //$chart_data .= "{ period:'".$row["time"]."', iphone:".$row["in2"].", ipad:".$row["in3"].", itouch:".$row["in4"]."}, ";
		 $chart_data .= "{ period:'".$row["time"]."', Temp:".$numTemp."-".$CAL."}, ";
		}
...
/////////////////อุณหภูมิ	
	...
	$sql="SELECT * FROM register WHERE chipid = '$mac'"; //  WHERE chipid = '$search' 
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" >TopCooling DashBoard</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
						...
						<tr>
							...
							<th><?php echo $name6 ;?></th>
							<th><?php echo $name7 ;?></th>
							<th><?php echo $name8 ;?></th>
							<th><?php echo $name9 ;?></th>
							<th>GRAPH</th>
				...
				<!--
                <div class="col-lg-4">
                    <div class="panel panel-default" id="notifi">
                        <div class="panel-heading">
