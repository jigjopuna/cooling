...
echo "<META HTTP-EQUIV='Refresh' CONTENT = '300;'>";	
	...
	$sql="SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no DESC LIMIT 20  "; //WHERE chipid LIKE $search 
	
	$Csql="SELECT * FROM register WHERE chipid = '$search'  "; //WHERE chipid LIKE $search 
