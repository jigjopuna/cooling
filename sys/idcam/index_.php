<?php session_start();
	...
	if($velas == '60')
	{
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no DESC LIMIT 60";
	}
	else if($velas == '180')
	{
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no DESC LIMIT 180";		
	}
	else if($velas == '360')
	{
		$sql = "SELECT * FROM datalogger WHERE chipid = '$search' ORDER BY no DESC LIMIT 360";
	}
	else if($velas == '720')
	{
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<!--
                <a class="navbar-brand" > 555555 ชื่อลูกค้า </a>
				-->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							<a href="http://80.211.47.159/index.php?search=<?php echo $search;?>&vela=40320"><button class="button">M</button></a>
                        </div>
                        <!-- /.panel-heading -->
