...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">แก้ไขอุปกรณ์ห้องเย็น</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="row">
								<form action="../db/shoptcl/room_edit_save.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
									<div class="col-lg-2">
									...
									<div class="col-lg-2">
										...
										<div id="proname" class="form-group has-success">
											...
											<input type="text" class="form-control" id="pr_size" name="pr_size" value="<?php echo $rowprod['pr_size'];?>">
										</div>
										
										<div id="proname" class="form-group has-success">
											<label class="control-label" for="inputSuccess">วิดีโอ</label>
											<input type="text" class="form-control" id="pr_vdo" name="pr_vdo" value="<?php echo $rowprod['pr_vdo'];?>">
										</div>
									</div>
									...
									<div class="col-lg-2">
										...
										<div id="proname" class="form-group has-success">
											...
											<input type="text" class="form-control" id="pr_length" name="pr_length" value="<?php echo $rowprod['pr_length'];?>">
										</div>
									...
									<div class="col-lg-2">
										...
										<div id="proname" class="form-group has-success">
											...
											<input type="text" class="form-control" id="" name="pr_weight" value="<?php echo $rowprod['pr_weight'];?>">
										</div>
