<?php  session_start(); 
	...
	//นับออเดอร์ของลูกค้าทั้งหมดที่เคยซื้อ
	$sql_cntusord = "select count(*) cnt from tb_order o WHERE o.o_user= '$u_id'";
