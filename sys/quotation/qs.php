...
<head>
	...
	<script>
		$(document).ready(function(){	
			...
			setdefault();  // set ค่าให้เป็น 0 ตอนที่ user กด back browser กลับมา ค่าบางอย่างอาจไม่ถูกต้อง ให้ใส่ค่าใหม่ทุกครั้งเมื่อกดปุ่ม Back
			$('#chkthreeside').change(showthreeside);	//แสดงช่อง 3 ด้าน
	...
	function showthreeside(){
		/*if ($(this).is(':checked')) {
				   $('.threeside').removeClass("hide");
				}else{
					$('.threeside').addClass("hide");
				}
		*/
	}
	
	function setdefault(){
		$( "#chkthreeside" ).prop( "checked", false ); // ให้ค่าเริ่มต้นไม่ติ๊กที่ 3 ด้าน
		$('#r_width2, #r_length2').val(0);
	}
	</script>  
</head>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="row">
								<form action="../../admin/qadmins.php" id="form1" name="form" method="post">
									<div class="col-lg-4">
									
										<div class="form-group has-success">
											<label class="control-label" for="inputSuccess"> เอาทั้ง 4 ด้าน </label>
											<input type="radio" class="form-control" id="nowidth" name="nowall" checked value="1">
										</div>
										
										<div class="form-group has-success">
											<label class="control-label" for="inputSuccess"> ไม่เอาด้านกว้าง </label>
											<input type="radio" class="form-control" id="nowidth" name="nowall" value="2">
										</div>
										
										<div class="form-group has-success">
											<label class="control-label" for="inputSuccess"> ไม่เอาด้านยาว </label>
											<input type="radio" class="form-control" id="allwall" name="nowall" value="3">
										</div>
