<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/333590/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:333590, name:'monatfood',key:'BCHLRI9HH7S0JQ7B', fieldList:[{field:1,axis:'O'}]});
