<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/393681/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:393681, name:'pawineephapha',key:'MK4OSIHTWVVMLAMI', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/393681/feeds.json?results=288", function (data) {
