<?php 
	...
	/*
		...
		email: terapatdrink_ch@topcooling.net
		pass : Webpom123456
		ssid : PEPSI CR
		wifi : tenshinhan
		

		key: THLO3APRT7T14SNR
		Channel ID: 593857
		Author: terapatdrink
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/593857/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:593857, name:'terapatdrink',key:'THLO3APRT7T14SNR', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/593857/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > บจก.ถิรภัทร เชียงรายตอนนี้  <?php echo $tempnow; ?> องศา</div>
