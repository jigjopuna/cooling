<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/333534/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:333534, name:'testing',key:'MKHZ8SRM2O62YAVM', fieldList:[{field:1,axis:'O'}]});
