<?php 
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/503456/feeds.json?results=1";
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/503456/feeds.json?results=288", function (data) {
