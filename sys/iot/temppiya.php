<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/396620/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:396620, name:'piyapor',key:'UG80VC11A2ARN6DG', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/396620/feeds.json?results=288", function (data) {
