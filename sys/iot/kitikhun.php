<?php 
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/504271/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:504271, name:'kitikhun',key:'XH6BOUUXYMJ8R0RL', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/504271/feeds.json?results=288", function (data) {
