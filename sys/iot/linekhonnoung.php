<?php 
	...
	$msg = "ห้องเย็นคุณหนึ่ง อุณหภูมิ ณ ปัจจุบัน  ";
	//$msg = "ห้องเย็นคุณหนึ่ง อุณหภูมิ ณ ปัจจุบัน  ".$dates.$tempnow." เฉลี่ยวันนี้ ".$avg." องศาเซลเซียส". " สูงสุด ".$maxtemp. " ดูกราฟได้ที่ http://topcooling.net/sys/iot/tempn.php";
