<?php 
	...
	/*
		...
		email: knoo@topcooling.net
		pass : Webpom123456
		ssid : 
		wifi : 
		
		key: ZSB3K64RA1YXWD6G
		Channel ID: 700828
		Author: knoo45
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/700828/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:700828, name:'knoo45',key:'ZSB3K64RA1YXWD6G', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/700828/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ คุณหนู ตอนนี้  <?php echo $tempnow; ?> องศา</div>
