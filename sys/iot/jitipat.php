<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/444404/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:444404, name:'augofocus',key:'2386DAWI6F6N3ULO', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/444404/feeds.json?results=288", function (data) {
