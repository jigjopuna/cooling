...
var channelKeys =[];
channelKeys.push({channelNumber:657034, name:'yajean',key:'EGL3B3P3JJOQ9CQG', fieldList:[{field:1,axis:'O'}]});
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ ลูกตาล ตอนนี้  <?php echo $tempnow; ?> องศา</div>
