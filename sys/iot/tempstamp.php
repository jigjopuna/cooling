<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/346426/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:346426, name:'TP Cooling',key:'91QWZ5VYLWZXXVTK', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/346426/feeds.json?results=288", function (data) {
