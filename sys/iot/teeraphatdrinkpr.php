<?php 
	...
	/*
		...
		email: terapatdrink_prea@topcooling.net
		pass : Webpom123456
		ssid : pepsiphrae
		wifi : 1141wert
		

		key: EQEQ7SWW6KBUJF0I
		Channel ID: 593864
		Author: terathai
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/593864/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:593864, name:'terathai',key:'EQEQ7SWW6KBUJF0I', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/593864/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > บจก.ถิรภัทร แพร่ ตอนนี้  <?php echo $tempnow; ?> องศา</div>
