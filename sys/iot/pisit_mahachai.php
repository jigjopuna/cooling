<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/424922/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:424922, name:'pisit',key:'GBEWX8P83RYF664A', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/424922/feeds.json?results=288", function (data) {
