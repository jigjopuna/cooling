<?php 
	...
	/*
		email: meatalia@topcooling.net
		
		ssid : True_IoT_Router_WiFi_49208 
		pass : 39949208
		
		Keys : VRRR8UMLNRC5O4ZT
		Channel ID: 654700
		Author: meatalia
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/654700/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:654700, name:'meatalia',key:'VRRR8UMLNRC5O4ZT', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/654700/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ Meatalia ตอนนี้  <?php echo $tempnow; ?> องศา</div>
