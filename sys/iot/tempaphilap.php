<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/389708/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:389708, name:'profit_tspk4',key:'LS2R921P4RGCWD8R', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/389708/feeds.json?results=288", function (data) {
