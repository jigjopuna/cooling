<?php 
	...
	/*
		...
		email: pestee@topcooling.net
		pass : 
		ssid : 
		wifi : 
		
		Keys : HXQXVTBY6DY272F8
		Channel ID: 700832
		Author: pestee
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/700832/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:700832, name:'pestee',key:'HXQXVTBY6DY272F8', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/700832/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ เพสตรี ตอนนี้  <?php echo $tempnow; ?> องศา</div>
