<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/346872/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:346872, name:'vilaihanrn',key:'D9IIYXI1Y5FBYQ3U', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/346872/feeds.json?results=288", function (data) {
