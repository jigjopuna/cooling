<?php 
	...
	/*
		...
		email: lognam@topcooling.net
		pass : Webpom123456
		ssid : Farmsod
		wifi : 31052506
		
		key: EXCUJ884S4Q45MIM
		Channel ID: 747078
		Author: somchais
		Access: Public
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/747078/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:747078, name:'somchais',key:'EXCUJ884S4Q45MIM', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/747078/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ คุณศรเพรช ตอนนี้  <?php echo $tempnow; ?> องศา</div>
