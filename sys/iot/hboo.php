<?php 
	...
	/*
		...
		email: salapoa@topcooling.net
		pass : Webpom123456
		ssid : 
		wifi : 
		
		key: CZUEOZKS76JCHD3I
		Channel ID: 690166
		Author: salapaoboo
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/690166/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:690166, name:'salapaoboo',key:'CZUEOZKS76JCHD3I', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/690166/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ เฮียบู้ ตอนนี้  <?php echo $tempnow; ?> องศา</div>
