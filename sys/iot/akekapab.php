<?php 
	...
	/*
		email: supuk@topcooling.net
		pass : 
		ssid : 
		pass : 
		
		Keys : K9L6YIGJ5GVDZN36
		Channel ID: 551629
		Author: supaks
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/551629/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:551629, name:'supaks',key:'K9L6YIGJ5GVDZN36', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/551629/feeds.json?results=288", function (data) {
