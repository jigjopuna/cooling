<?php 
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/657034/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:657034, name:'lognam',key:'S1WMGDW8FRZQQBZ5', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/657034/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ บ.เอกภาพ ตอนนี้  <?php echo $tempnow; ?> องศา</div>
