<?php 
	...
	/*
		...
		email: thisana@topcooling.com
		pass : Webpom123456
		ssid : Sweetduck
		wifi : Udomrerkchai
		
		key: ZEDEJHX2U2WEKPHD
		Channel ID: 538288 
		Author: thisana
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/538288/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:538288, name:'thisana',key:'BVJO533TJLJFDERV', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/538288/feeds.json?results=288", function (data) {
