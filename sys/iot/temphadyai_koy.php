<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/404595/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:404595, name:'benjawan',key:'IYUH8JU2WK4HSYMG', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/404595/feeds.json?results=288", function (data) {
