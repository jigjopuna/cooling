<?php 
	...
	/*
		...
		email: arthon@topcooling.net
		pass : Webpom123456
		ssid : SALAD WIFI
		wifi : 0895894029
		
		key: LL6YNRNQKDDMIQWT
		Channel ID: 539699
		Author: arthon
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/539699/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:539699, name:'arthon',key:'LL6YNRNQKDDMIQWT', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/539699/feeds.json?results=288", function (data) {
