<?php 
	...
	/*
		email: chayabkk@topcooling.net	
		pass : 
		ssid : 
		pass : 
		
		Keys : ZP33N3TCV9M54BG0
		Channel ID: 654702
		Author: chayabkk
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/654702/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:654702, name:'chayabkk',key:'ZP33N3TCV9M54BG0', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/654702/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ คุณชยา ตอนนี้  <?php echo $tempnow; ?> องศา</div>
