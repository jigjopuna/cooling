<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/453987/feeds.json?results=1";
	$json = file_get_contents($json_url);
	$data = json_decode($json);
	$tempnow = $data->feeds[0]->field1;
    /*
	#define ssid "Pisit seafood 2.4 G"
	#define password "0628896546"
	const char* host = "api.thingspeak.com";    
	const char* api   = "MYCCIGSMHIRFVIX6"; 
	email : pisittrad@gmail.com
	*/
?>
<!DOCTYPE html>
<html>
...
var channelKeys =[];
channelKeys.push({channelNumber:453987, name:'pisittrad',key:'MYCCIGSMHIRFVIX6', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/453987/feeds.json?results=288", function (data) {
