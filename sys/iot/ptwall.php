<?php 
	...
	/*
		email: poraneecooling@yahoo.com
		pass : Webpom123456
		ssid : PT Wall
		pass : 0745555003921
		
		key: P5GFSEC5RR6FHXLF
		Channel ID: 520243
		Author: poraneecooling
	*/
	
	date_default_timezone_set("Asia/Bangkok");	
	
	$json_url = "https://api.thingspeak.com/channels/520243/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:520243, name:'poraneecooling',key:'P5GFSEC5RR6FHXLF', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/520243/feeds.json?results=288", function (data) {
