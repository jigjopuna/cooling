<?php 
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/568747/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:568747, name:'puttinpong',key:'L7X7RPZHW390JL8U', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/568747/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ คุณพุฒิพงษ์ ตอนนี้   <?php echo $tempnow; ?> องศา</div>
