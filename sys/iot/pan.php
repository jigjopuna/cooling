<?php 
	...
	/*
		...
		email: pankata@topcooling.net
		pass : webpom123456
		ssid : PCX
		wifi : 340046272
		
		key: QGMME7NUUG1R4IFY
		Channel ID: 522550
		Author: katanaja
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/522550/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:522550, name:'temperatureok',key:'QGMME7NUUG1R4IFY', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/522550/feeds.json?results=288", function (data) {
