<?php 
	...
	/*
		email: tinakorning@yahoo.com
		pass : Webpom123456
		ssid : mark_2.2G
		pass : 0847186117
		
		Keys : L4V0TZ0D88IQN3PI
		Channel ID: 528145
		Author: thinmak
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/528145/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:528145, name:'thinmak',key:'L4V0TZ0D88IQN3PI', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/528145/feeds.json?results=288", function (data) {
