<?php 
	...
	/*
		email: apfood@topcooling.net	
		pass : 
		ssid : 
		pass : 
		
		Keys : Y2EQM5FENQGGR9MG
		Author: apfoods
		Access: Public
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/707963/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:707963, name:'apfoods',key:'Y2EQM5FENQGGR9MG', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/707963/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ AP FOOD ตอนนี้  <?php echo $tempnow; ?> องศา</div>
