<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/373759/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:373759, name:'jumnene',key:'RFTSLQM8PPBJFZ1K', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/373759/feeds.json?results=288", function (data) {
