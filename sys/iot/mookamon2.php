<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/463053/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:463053, name:'Kamon2',key:'DLSOJ343JZBKZEO2', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/463053/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > ห้องบลาสอุณหภูมิ ตอนนี้  <?php echo $tempnow; ?> องศา</div>
