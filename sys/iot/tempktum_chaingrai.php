<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/418286/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:418286, name:'pork',key:'598PV71O78MT8YE9', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/418286/feeds.json?results=288", function (data) {
