<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/418904/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:418904, name:'aphiwat',key:'0CZ3RKIDK2ZF31UO', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/418904/feeds.json?results=288", function (data) {
