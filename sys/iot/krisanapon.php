<?php 
	...
	/*
		...
		email: krisanapon@topcooling.net
		pass : webpom123456
		User: 3k frozen food
		Password: 3k050822
		
		key: BGV2IKUXBCTWMQ38
		Channel ID: 522538
		Author: kidnaja
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/522538/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:522538, name:'kidnaja',key:'BGV2IKUXBCTWMQ38', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/522538/feeds.json?results=288", function (data) {
