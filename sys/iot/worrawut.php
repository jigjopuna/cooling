<?php 
	...
	/*
		...
		email: worrawut_changmai@topcooling.net
		pass : Webpom123456
		ssid : Siriluk
		wifi : 0947599292
		
		key: 13U18BP33JT2ALVC
		Channel ID: 558009
		Author: woramai
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/558009/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:558009, name:'woramai',key:'13U18BP33JT2ALVC', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/558009/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ ห้องเย็นคุณ วรวุฒิ ตอนนี้  <?php echo $tempnow; ?> องศา</div>
