<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/404413/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:404413, name:'ptwallcooling',key:'09QJZ82J9Q2XY2S9', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/404413/feeds.json?results=288", function (data) {
