<?php 
	...
	/*
		email: bangpama@topcooling.net
		pass : 
		ssid : 
		pass : 
		
		Keys : ZZQWLRMOW8N2M6C1
		Channel ID: 639407
		Author: bangpama
		Access: Public
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/639407/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:639407, name:'bangpama',key:'ZZQWLRMOW8N2M6C1', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/639407/feeds.json?results=288", function (data) {
