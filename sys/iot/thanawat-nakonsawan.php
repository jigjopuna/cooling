<?php 
	...
	/*
		...
		email: thanawat@topcooling.net
		pass : Webpom123456
		ssid : TOT FTTX5628j6011
		wifi : 0801218708
		
		key: THW1PUCBWOG7WBXO
		Channel ID: 538315
		Author: thanawats
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/538315/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:538315, name:'thisana',key:'BVJO533TJLJFDERV', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/538315/feeds.json?results=288", function (data) {
