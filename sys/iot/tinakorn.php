<?php 
	...
	/*
		...
		email: tinakorning@topcooling.net
		pass : Webpom123456
		
		ssid : Mintnung 
		wifi : 11052518
		
		key: EV4TLLOIB53CGVOB 
		Channel ID: 527201
		Author: tinakorning
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/527201/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:527201, name:'tinakorning',key:'EV4TLLOIB53CGVOB', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/527201/feeds.json?results=288", function (data) {
