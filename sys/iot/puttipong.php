<?php 
	...
	/*
		...
		email: puthipong_kum@topcooling.net
		pass : Webpom123456
		ssid : Puttipong_2.4GHz
		wifi : 0830772777
		
		key: CTFTWC4AVNU7LYOC
		Channel ID: 557116
		Author: puthipong
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/557116/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:557116, name:'puthipong',key:'CTFTWC4AVNU7LYOC', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/557116/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ ตอนนี้  คุณพุฒิพงษ์ <?php echo $tempnow; ?> องศา</div>
