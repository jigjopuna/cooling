<?php 
	...
	/*
		...
		email: yajean@topcooling.net
		pass : Webpom123456
		ssid : Farmsod
		wifi : 31052506
		
		key: EGL3B3P3JJOQ9CQG
		Channel ID: 690151
		Author: yajean
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/690151/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:690151, name:'yajean',key:'EGL3B3P3JJOQ9CQG', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/690151/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ ลิ้ม เซี้ยง เฮง ตอนนี้  <?php echo $tempnow; ?> องศา</div>
