<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/402788/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:402788, name:'cooltemp',key:'Z0BZOWX3BC24ELOV', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/402788/feeds.json?results=288", function (data) {
