<?php 
	...
	/*
		email: nokloa@topcooling.net
		pass : 
		ssid : 
		pass : 
		
		Keys : VGVNK3LGSOCU4JL7
		Channel ID: 712634
		Author: nokloa
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/712634/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:712634, name:'nokloa',key:'VGVNK3LGSOCU4JL7', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/712634/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ พี่นก (ลาว) ตอนนี้  <?php echo $tempnow; ?> องศา</div>
