<?php 
	...
	/*
		email: wissanu030@hotmail.co.th
		pass : Webpom123456
		ssid : AIS 4G Mr.Wissanu
		pass : 06062531
	*/
	
	date_default_timezone_set("Asia/Bangkok");	
	
	$json_url = "https://api.thingspeak.com/channels/451682/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:451682, name:'wissanu',key:'8HR5BJKKVSXY0XE6', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/451682/feeds.json?results=288", function (data) {
