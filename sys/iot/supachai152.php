<?php 
	...
	/*
		...
		email: supachai@topcooling.net
		pass : 
		ssid : 
		wifi : 
		
		Keys : S8RDNWX9W3SIDO3C
		Channel ID: 705402
		Author: supachai152
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/705402/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:705402, name:'supachai152',key:'S8RDNWX9W3SIDO3C', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/705402/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ คุณศุภชัย ตอนนี้  <?php echo $tempnow; ?> องศา</div>
