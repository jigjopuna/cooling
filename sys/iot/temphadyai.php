<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/404591/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:404591, name:'roncooling',key:'YJ11ZBX99WGFHCXK', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/404591/feeds.json?results=288", function (data) {
