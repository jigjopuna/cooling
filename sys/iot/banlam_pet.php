<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/425571/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:425571, name:'shell',key:'BXJPEO28YUSKRFXG', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/425571/feeds.json?results=288", function (data) {
