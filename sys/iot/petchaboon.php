<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/465941/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:465941, name:'petcha',key:'J4UI731TMY0BLEYX', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/465941/feeds.json?results=288", function (data) {
