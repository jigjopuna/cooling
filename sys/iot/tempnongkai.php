<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/416291/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:416291, name:'Pork',key:'C78ZXD5R47MIT1B8', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/416291/feeds.json?results=288", function (data) {
