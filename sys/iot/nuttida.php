<?php 
	...
	/*
		...
		email: nuttida_konwan@topcooling.net //farmsod@topcooling.net
		pass : Webpom123456
		ssid : nattida
		wifi : 19022529
		
		key: VDE90TIM0FEL6GUL  //MXM154X3OSD8L10A
		Channel ID: 592736
		Author: nuttida  //farmsod
	*/
	
	date_default_timezone_set("Asia/Bangkok");	
	
	$json_url = "https://api.thingspeak.com/channels/592736/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:592736, name:'farmsod',key:'MXM154X3OSD8L10A', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/592736/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ คุณณัฐธิดา ตอนนี้  <?php echo $tempnow; ?> องศา</div>
