<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/449816/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:449816, name:'unnzapong',key:'MKGJOQXYZ45EADPM', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/449816/feeds.json?results=288", function (data) {
