<?php 
	...
	/*
		email: watersfresh946s@yahoo.com
		pass : Webpom123456
		ssid : Sittchan
		pass : 3100400121917
		
		key: 04VYDO8G1VE1VN8Z
		Channel ID: 520323
		Author: waterss
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/520323/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:520323, name:'waterss',key:'04VYDO8G1VE1VN8Z', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/520323/feeds.json?results=288", function (data) {
