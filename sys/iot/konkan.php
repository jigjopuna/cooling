<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/457677/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:457677, name:'teerasingda',key:'VUZWO8LNJMPACGQV', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/457677/feeds.json?results=288", function (data) {
