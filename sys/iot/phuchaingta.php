<?php 
	...
	/*
		email: phuchaingta@topcooling.net
		pass : Webpom123456
		ssid : 
		pass : 
		
		Keys : MT4L4ZI8WLV4PCBG
		Channel ID: 549239
		Author: phucsna	
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/549239/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:549239, name:'phucsna',key:'MT4L4ZI8WLV4PCBG', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/549239/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ ภูเชียงทา ตอนนี้  <?php echo $tempnow; ?> องศา</div>
