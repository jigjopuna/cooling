<?php 
	...
	/*
		...
		email: puttiboon@topcooling.net
		pass : Webpom123456
		ssid : V_CHAROEN 2.4 Ghz
		wifi : 0894744440
		
		Keys : H5UPO3D4D1PQLUPF
		Channel ID: 570850
		Author: wichain
	...
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/570850/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:570850, name:'wichain',key:'H5UPO3D4D1PQLUPF', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/570850/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ วิเชียร ตอนนี้   <?php echo $tempnow; ?> องศา</div>
