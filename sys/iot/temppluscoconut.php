<?php 
	...
	$json_url = "https://api.thingspeak.com/channels/381597/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:381597, name:'coconun',key:'YEU7L3IXEEQYB9HE', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/381597/feeds.json?results=288", function (data) {
