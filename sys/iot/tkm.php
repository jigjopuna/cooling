<?php 
	...
	/*
		...
		email: tkm@topcooling.net
		pass : Webpom123456
		ssid : TKMTHAILAND_2.4G
		wifi : 0907812005
		
		key: 62RNPE6IYMAVY9EX
		Channel ID: 616818
		Author: tkmpork
	*/
	...
	$json_url = "https://api.thingspeak.com/channels/595676/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:595676, name:'fruittynarak',key:'LMRL10RC6XAN4WN0', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/595676/feeds.json?results=288", function (data) {
...
function loadChannelHistory(sentChannelIndex,channelNumber,key,sentFieldList,sentNumLoads,maxLoads) {
  ...
  <?php require_once('../../include/googletag.php');?>
	<div id="curtime" style="margin: auto 0; font-size: 30px; float:none; width: 100%; text-align: center;" > อุณหภูมิ ฟาร์มสด ตอนนี้  <?php echo $tempnow; ?> องศา</div>
