<?php 
	...
	/*
		email: kometnajath@gmail.com
		pass : Webpom123456
		Username : thefarmbuffet
		Password  : buffet2018
	*/
	
	date_default_timezone_set("Asia/Bangkok");	
	
	$json_url = "https://api.thingspeak.com/channels/505685/feeds.json?results=1";
...
var channelKeys =[];
channelKeys.push({channelNumber:505685, name:'komets',key:'N8WBY1HTKT5I38GZ', fieldList:[{field:1,axis:'O'}]});
...
$(document).ready(function() 
{
 ...
 //custom
 $.getJSON("https://api.thingspeak.com/channels/505685/feeds.json?results=288", function (data) {
