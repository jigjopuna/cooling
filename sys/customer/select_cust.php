...
<body>
    ...
    <div id="wrapper">
		<?php 
			...
			if($ro_cust!=1){ exit("<script>alert('ไม่มีสิทธิ์ในการดูลูกค้านะคะ'); window.location = '../index.php';</script>");}
                        ...
                        <div class="panel-body">
							<div class="row">
								<form action="" method="post" name="form1" id="form1" enctype="multipart/form-data">
									<div class="col-lg-2">
										<a href="customer.php"><div id="r_sumred" class="r_box"><p>ลูกค้าห้องเย็น</p></div></a>
									</div>
									
									
									<div class="col-lg-3">
										<a href="cust_iot.php"><div id="r_embed" class="r_box"><p>ลูกค้า IoT</p></div></a>
									</div>
									
																		
									<div class="col-lg-3">
									   <a href="cust_service.php"><div id="" class="r_box"><p>ลูกค้าเซอร์วิส</p></div></a>
									</div>
