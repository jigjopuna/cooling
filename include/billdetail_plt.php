			<div id="contact" style="/*background-color:pink;*/ margin-top:20px; overflow:hidden;">
				<div id="contact" style="/*background-color:orange;*/ height:150px; float:left; width: 55%; border: 1px dashed black;  border-radius: 10px;" >
					<p style="padding-left: 20px;">รหัสลูกค้า / Code : TP0<?php echo $row_cust['cuplt_id'];?><br>
					นามลูกค้า / Name : <?php echo $row_cust['cuplt_name']; ?><br> 
					ที่อยู่ / Address: 
					<?php 
						echo $row_cust['cuplt_address'].' '; 
						if($row_cust['cuplt_province']==102){
						...
						echo ' '.$row_cust['cuplt_zip'];					
					?>
					<br> 
					โทรศัพท์ / Tel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo $row_cust['cust_tel']?><br>
					เลขที่ประจำตัวผู้เสียภาษี / Tax ID : <?php echo $row_cust['cuplt_tax']?></p>
				</div>
