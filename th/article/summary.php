									...
									<?php 
									  ...
									  ?>
										<tr class="gradeA"> 
											...
											<td><?php echo number_format($row['cash_now'], 0, '.', ','); ?></td>
											<td><?php echo number_format($row['cash_now1'], 0, '.', ','); ?></td>
											...
											<td><?php echo number_format($row['cash_emp1'], 0, '.', ','); ?></td>
											
											<td><?php echo number_format($row['cash_temp'], 0, '.', ','); ?></td>
											<td><?php echo number_format($row['cash_temp1'], 0, '.', ','); ?></td>
										</tr>
									<?php } ?>
