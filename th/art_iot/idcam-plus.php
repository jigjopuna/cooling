...
<meta name="keywords" content="ห้องเย็น IoT, Internet of Thing">
<meta name="description" content="ถ้าห้องเย็นเสียแล้วช่างยังไม่มาซ่อมสักที ของในห้องเย็นจะเสียไหม นี้คือปัญหาของคนใช้ห้องเย็น หมดปัญหานี้ทันทีด้วยระบบ IoT รุ่น IDCAM Plus">
<meta property="og:title" content="ห้องเย็นอัจฉริยะ ฉลาด แสนรู้ จริงๆ นะ"/>
...
<meta property="og:description" content="ถ้าห้องเย็นเสียแล้วช่างยังไม่มาซ่อมสักที ของในห้องเย็นจะเสียไหม นี้คือปัญหาของคนใช้ห้องเย็น หมดปัญหานี้ทันทีด้วยระบบ IoT รุ่น IDCAM Plus"/>
<link rel="shortcut icon" href="../../content/images/favicon.png">
<link rel="stylesheet" href="../../sources/css/main.css">
<title>ห้องเย็นอัจฉริยะ ฉลาด แสนรู้ จริงๆ นะ</title>
		...
		<div class="row" id="">
			<div class="col-md-12">
				<div class="heading" style="text-align: center;">
					ระบบที่ของในห้องเย็นจะไม่เสีย
				</div>
				
				<br><br>
				
				<img src="../../shop/images/iot/plus/plus1.png" style="width: 40%;" alt="iot ห้องเย็น"><br><br>
			
				<div class="p_article">
					<h2>ระบบห้องเย็นออนไลน์</h2>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					IDCAM Plus เป็นอุปกรณ์ (IoT) ที่ออกแบบให้ใช้งานกับห้องเย็นโดยเฉพาะ ช่วยให้ผู้ใช้งานสามารถ <span class="text-strong">ติดตาม</span> สถานะการทำงานของห้องเย็นได้ตลอดเวลาผ่านการเชื่อมต่ออินเตอร์เน็ตแบบ Real Time จะเก็บข้อมูลทุกๆ 5 นาที <br><br>
					
					<span class="text-large">ประโยชน์เด่นๆ</span> ของ IDCAM Plus ช่วย <span class="text-strong">ลดความเสี่ยง</span> ของที่เก็บหรือแช่แข็งไว้ในห้องเย็นเสีย เพราะเราจะไม่ให้ห้องเย็นลูกค้าเสีย โดยระบบนี้จะแจ้งเตือนทันทีหากอุณหภูมิให้ห้องเย็นไม่ได้อุณหภูมิตามที่เราต้องการหรือระบบห้องเย็นมีปัญหา เช่น กระแสไฟฟ้าสูง จนทำให้ระบบหยุดการทำงาน <br><br>
					...
					<br><br>
					 ...
					 โดยการทำงานของระบบนี้ จะเก็บข้อมูล ขึ้นระบบ <span class="text-strong">คลาวด์ (Cloud)</span> ทุกๆ 5 นาที หรือมากน้อยกว่านี้ก็ได้ตามต้องการ และเราสามารถวิเคราห์การทำงานของเครื่องได้จาก Big Data ที่เราเก็บข้อมูลไว้ และบริการการเรียกรายงาน Report ได้  มีรายละเอียดดังต่อไปนี้<br><br>
					...
					<iframe width="100%" height="400" src="https://www.youtube.com/embed/LTF30Kz8aLQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
