					...
					<tbody>
					  ...
					  ?>
							<tr class="odd gradeX">
								...
								<td><button type="button" class="btn btn-lg btn-success btn-block" id="btn_buy" value="<?php echo $row['p_id']?>" >สั่งซื้อ</button></td>
								<td><button type="button" class="btn btn-lg btn-success btn-block" id="btn_q" value="<?php echo $row['p_id']?>">ใบเสนอราคา</button></td>
