...
<div id="sec2" class="section-2">
		...
		<div class="row" id="">
			<div class="col-md-12">
				...
				<p class="p_article">
					...
					ซึ่งจะแบ่งเป็น 2 หัวข้อดังนี้<br> <br>
					...
					2. รู้ขนาดเครื่อง โดยการคำนวนจากเงื่อนไขต่างๆ<br>
					 ...
					 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  2.2 ระยะเวลาลดอุณหภูมิให้ได้ตามกำหนด<br>
			...
			<br><br>
					...
					และผมต้องการอีกว่าให้หมูลดอุณหภูมิจาก 25 องศา ให้ได้ 0 องศา ภายใน 12 ชั่วโมง<br><br>
	...
	โปรแกรมคำนวณราคาห้องเย็น <i style="font-size: 18px; vertical-align: baseline;" class="fa fa-play-circle-o"></i>
					...
					<br><br><br>
					<span class="strong-under">ตัวอย่างเช่น</span> เราต้องการลดอุณหภูมิสินค้าให้ได้ภายใน 12 ชั่วโมง แต่ไปซื้อเครื่องที่เล็กกว่าราคาถูกกว่า ที่ลดอุณหภูมิได้เร็วสุด 18 ชั่วโมง มันไม่ตรงกับความต้องการของเรานิ คราวนี้เครื่องทำงานหนักแน่นอนที่จะเร่งลดอุณภูมิ 0 องศา ให้ได้ใน 12 ชั่วโมง
					
					
					<br><br>
					หวังว่าบทความนี้จะเป็นประโยชน์ ในการเลือกซื้อเย็นนะครับ ^^<br><br>
