        ...
        <div class="subpage">
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						<td>1.<input name="r1" class="pdesc" type="text" value="<?php echo "แผ่นฉนวนสำเร็จรูปสำหรับผนังและเพดาน "." หนา ".$row_isowall['pr_size']." Type ".$row_isowall['pr_type'];?>"></td>
					...
					<tr>
						<td>2. <input name="r2" class="pdesc" type="text" value='<?php echo $row_floor['catr_name']." หนา ".$row_floor['pr_size'].$row_floor['pr_density']."lb";?>'></td>
						...
						<td class="l" align="right"><input name="r2p" class="punit" type="text" value="<?php echo number_format($row_floor['pr_sell_price']*$percentprice, 2, '.', ',');?>"></td>
