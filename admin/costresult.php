<?php
   ...
   if($row_condensing['p_hp']>=21){
	...
	$tatal_price =  ($row_condensing['p_sell_price_sell']*$condensingmaxqty) + 
					($row_cooler['p_sell_price_sell']*$qtycooler) +
					($row_dc['p_sell_price_sell']*$condensingmaxqty) + 
					($row_expand['p_sell_price_sell']*$expandmaxqty) + 
					($row_tube2['p_sell_price_sell']*2*$qtycooler) +
					($row_tube1['p_sell_price_sell']*2*$qtycooler) +
					($row_curve1['p_sell_price_sell']*5*$condensingmaxqty) +
					($row_curve2['p_sell_price_sell']*5*$condensingmaxqty) + 
					($row_curve3['p_sell_price_sell']*$qtycooler) +
					($row_ins['p_sell_price_sell']*$qtycooler*2*3) + 
					($row_numya['p_sell_price_sell']*$numyaQty*$condensingmaxqty) + 
					($cable)*$condensingmaxqty
										;
    ...
    <div class="page">
        <div class="subpage">
            ...
            <div id="cover_header">
				...
				<div style="float:left; line-height:20px; margin: 0 0 0 40px;">
			...
			<div id="contect_detail" style="margin-top:85px;">
				<div class="cust" style="float:left; width:65%; line-height:20px;">
					<?php require_once('../include/custaddress.php'); ?>
				
				</div><!--end cust-->
				
				<div class="oweneraddress" style="float:left; width: 32%; line-height:22px;">
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_condensing['p_sell_price']+($row_condensing['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_condensing['p_sell_price']+($row_condensing['p_sell_price']*$percentprice))*$condensingmaxqty, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_cooler['p_sell_price']+($row_cooler['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_cooler['p_sell_price']+($row_cooler['p_sell_price']*$percentprice))*$qtycooler, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>3. <?php echo $row_dc['cat_name']." ";echo '"'; echo $row_dc['p_name']; echo '"'. " ";  echo $row_dc['p_model'];?></td>
						<td colspan="2" class="l" align="center"><?php echo $condensingmaxqty; ?></td>
						<td class="l" align="right"><?php echo number_format($row_dc['p_sell_price']+($row_dc['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_dc['p_sell_price']+($row_dc['p_sell_price']*$percentprice))*$condensingmaxqty, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_expand['p_sell_price']+($row_expand['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_expand['p_sell_price']+($row_expand['p_sell_price']*$percentprice))*$expandmaxqty, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_tube2['p_sell_price']+($row_tube2['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_tube2['p_sell_price']+($row_tube2['p_sell_price']*$percentprice))*2*$qtycooler, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>6. <?php echo $row_tube1['cat_name']."ทางส่ง"; echo " Type ".$row_tube1['p_type']." Size "; echo $row_tube1['p_size'].'"'?></td>
						<td colspan="2" class="l" align="center"><?php echo $qtycooler*2; ?></td>
						<td class="l" align="right"><?php echo number_format($row_tube1['p_sell_price']+($row_tube1['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_tube1['p_sell_price']+($row_tube1['p_sell_price']*$percentprice))*2*$qtycooler, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_curve1['p_sell_price']+($row_curve1['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_curve1['p_sell_price']+($row_curve1['p_sell_price']*$percentprice))*5*$condensingmaxqty, 2, '.', ','); ?></td>
					...
					<tr>
						...
						<td colspan="2" class="l" align="center"><?php echo $condensingmaxqty*5;?></td>
						<td class="l" align="right"><?php echo number_format($row_curve2['p_sell_price']+($row_curve2['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_curve2['p_sell_price']+($row_curve2['p_sell_price']*$percentprice))*5*$condensingmaxqty, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>9. <?php echo $row_curve3['cat_name']." Size ".$row_curve3['p_size'].'"' ?></td>
						<td colspan="2" class="l" align="center"><?php echo $qtycooler?></td>
						<td class="l" align="right"><?php echo number_format($row_curve3['p_sell_price']+($row_curve3['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_curve3['p_sell_price']+($row_curve3['p_sell_price']*$percentprice))*$qtycooler, 2, '.', ','); ?></td>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_ins['p_sell_price']+($row_ins['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_ins['p_sell_price']+($row_ins['p_sell_price']*$percentprice))*$qtycooler*2*3, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_numya['p_sell_price']+($row_numya['p_sell_price']*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format(($row_numya['p_sell_price']+($row_numya['p_sell_price']*$percentprice))*$numyaQty*$condensingmaxqty, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>12. <?php echo "สายไฟและท่อเดินสายไฟ"?></td>
						<td colspan="2" class="l" align="center"><?php echo $condensingmaxqty; ?></td>
						<td class="l" align="right"><?php echo number_format($cable+($cable*$percentprice), 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format($cable+($cable*$percentprice)*$condensingmaxqty, 2, '.', ','); ?></td>
			...
			<div id="conclude" style="clear: both; line-height:20px;">
				
				<span><strong>เงื่อนไขการคำนวณ </strong></span><br>
				...
				<span>ปริมาณสินค้า : <?php echo $qty?> กิโลกรัม</span><br> 
		...
		<?
			...
			$sql_sling = "SELECT * FROM tb_categoryroom c JOIN tb_productroom p ON c.catr_id = p.pr_cate 
							WHERE p.pr_cate = 7";
			$result_sling = mysql_query($sql_sling);
			$row_sling = mysql_fetch_array($result_sling);
			...
			$tatal_price2 = ($row_isowall['pr_sell_price']*$var_room) +
							($row_floor['pr_sell_price']*$var_florom) +
							($row_plastic['pr_sell_price']*$var_florom) +
							($row_seal['pr_sell_price']*$var_seal) +
							($row_aluminium['pr_sell_price']*$var_room) +
							($row_silicon['pr_sell_price']*$var_silicon) +
							$row_door['pr_sell_price'] +
							$row_man['pr_sell_price']
							; 
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_isowall['pr_sell_price'], 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format($row_isowall['pr_sell_price']*$var_room, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_floor['pr_sell_price'], 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format($row_floor['pr_sell_price']*$var_florom, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>3. <?php echo $row_plastic['catr_name'];?></?></td>
						<td colspan="2" class="l" align="center"><?php echo $var_florom." ตร.ม."?></td>
						<td class="l" align="right"><?php echo number_format($row_plastic['pr_sell_price'], 2, '.', ',');?></td>
					...
					<tr>
						...
						<td colspan="2" class="l" align="center"><?php echo $var_room." ตร.ม."?></td>
						<td class="l" align="right"><?php echo number_format($row_aluminium['pr_sell_price'], 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format($row_aluminium['pr_sell_price']*$var_room, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($row_seal['pr_sell_price'], 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format($row_seal['pr_sell_price']*$var_seal, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>6. <?php echo $row_silicon['catr_name']."ชนิดกันเชื้อรา";?></?></td> 
						<td colspan="2" class="l" align="center"><?php echo $var_silicon." หลอด"?></td>
						<td class="l" align="right"><?php echo number_format($row_silicon['pr_sell_price'], 2, '.', ',');?></td>
						<td class="l" align="right"><?php echo number_format($row_silicon['pr_sell_price']*$var_silicon, 2, '.', ','); ?></td>
					</tr>
					...
					<tr>
						<td>9. <?php echo $row_sling['catr_name'];?></?></td>
						<td colspan="2" class="l" align="center">0</td>
						<td class="l" align="right"><?php //echo number_format($row_sling['pr_sell_price'], 2, '.', ',');?>0</td>
						<td class="l" align="right"><?php //echo number_format($row_sling['pr_sell_price'], 2, '.', ','); ?>0</td>
					</tr>
