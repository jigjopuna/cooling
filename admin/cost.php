<?php
   ...
   //require_once('../savedb/cust_address.php');
	...
	$lbmt = $labormachineunit*$labormachinepirce;
	
	/*shmt = ship machine total */
	$shmt = $shipmachineunit*$shipmachineprice;
	
	
	/*lbrt = labor room total */
	$lbrt = $laborroomunit*$laborroomprice;
	
	/*shrt = ship room total */
	$shrt = $shiproomunit*$shiproomprice;
	...
	$r8t = $r8q*$r8p;
	$r9t = $r9q*$r9p;
	$rpressure_t = $r_pressureq*$r_pressure_p;
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($labormachinepirce, 2, '.', ',');?></td>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($shipmachineprice, 2, '.', ',');?></td>
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($r_pressure_p, 2, '.', ',');?></td>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($laborroomprice, 2, '.', ',');?></td>
					...
					<tr>
						...
						<td class="l" align="right"><?php echo number_format($shiproomprice, 2, '.', ',');?></td>
