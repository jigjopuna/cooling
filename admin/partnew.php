	...
	<div class="page">
        <div class="subpage">
			...
			<div id="product_price" style="margin-top:10px; clear:both; ">
					...
					<tr class="highs" style="">
						<td class="l">1. อลูมิเนียมฉากบาง</td>
						<td colspan="2" class="l" align="center">1 เส้น</td>
						<td class="l" align="right"></td>
						<td class="l" align="right">47,800.00</td>
					</tr>
					
					<tr class="highs" style="">
						<td class="l">2. อลูมิเนียมฉากบาง</td>
			...
			<div id="amount" style="clear: both; margin-top: 10px;">
				<div style="width: 50%; float:left;">
					<table style="width: 100%; border-collapse: collapse;">
						...
						<tr>
							<td align="left">บัญชีธนาคารกรุงเทพ(สะสมทรัพย์)</td>
							<td align="left"></td>
							<tr>
