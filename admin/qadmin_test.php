...
<form method="post" action="pfq.php"id="form1">
    <div class="page">
		...
		<?/*if($temparature <=4 ){
				...
				$sql_floor = "SELECT * FROM tb_categoryroom c JOIN tb_productroom p ON c.catr_id = p.pr_cate WHERE p.pr_cate = 2 AND p.pr_size = 4";
				...
				$sql_isowall = "SELECT * FROM tb_categoryroom c JOIN tb_productroom p ON c.catr_id = p.pr_cate WHERE p.pr_cate = 1 AND p.pr_size = 8";		
				$sql_floor = "SELECT * FROM tb_categoryroom c JOIN tb_productroom p ON c.catr_id = p.pr_cate WHERE p.pr_cate = 2 AND p.pr_size = 8";
        ...
        <div class="subpage">
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						<td>1.<input name="r1" class="pdesc" type="text" value="<?php echo "แผ่นฉนวนสำเร็จรูปสำหรับผนังและเพดาน "." หนา ".$inch2." นิ้ว ";?>"></td>
						<td colspan="2" class="l" align="center"><input name="r1q" style="width:45px;" class="punit" type="text" value="<?php echo $isoside+$isoceil;?>"> แผ่น</td>
						<td class="l" align="right"><input name="r1p" class="punit" type="text" value="<?php echo number_format($isoprice, 2, '.', ',');?>"></td>
						<td class="l" align="right"><?php echo number_format($price_isoside + $price_isoceil, 2, '.', ','); ?></td>
					</tr>
					
					<tr>
						<td>2. <input name="r2" class="pdesc" type="text" value='<?php echo "โฟมพื้น ขนาด ".$inch2. " นิ้ว ";?>'></td>
						<td colspan="2" class="l" align="center"><input name="r2q" style="width:45px;" class="punit" type="text" value="<?php echo $qtypaper?>"> แผ่น</td>
						<td class="l" align="right"><input name="r2p" class="punit" type="text" value="<?php echo number_format($flr_cost, 2, '.', ',');?>"></td>
