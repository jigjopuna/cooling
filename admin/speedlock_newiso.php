        ...
        <div class="subpage">
			...
			<div id="footer" style="clear: both;">
				...
				<div style="width: 35%; float:left; margin-top: 20px;">
					...
					<span>(นาย ภูริชญ์ โชคอุตสาหะ)</span> <br><br>
	...
	<div class="page">
        <div class="subpage">
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					<tr>
						<td colspan="5" align="center" style="background: #DAD7D7; border: 1px solid black;">รายละเอียดห้องเย็นใหม่ เครื่องมือสอง</td>
					</tr style="border: solid black 1px;">
					
					<tr border='1' align="center">
						<td style="width: 60%" align="left">ห้องเย็นติดตั้งหน้างานปริมาณแผ่นฉนวน (<?php echo $cute; ?>) ตารางเมตร</td>
					...
					<tr class="highs" style="">
						<td class="l">1. ชุด Condensing 
							<strong><u>
							<?php echo $compressor_name;?>  มือสอง
							</u></strong>
					...
					<tr class="highs" style="">
						<td class="l">3. ผนังห้องเย็น โฟม <span style="font-weight:bold; text-decoration:underline; font-size:18px; color:red;"> <?php echo $foams." ".$foaminch; ?> นิ้ว</span> <span style="font-size: 12px;"> เหล็ก BHP 0.45 เมตร</span> <strong><u>ชุดใหม่</u></strong> </td>
						<td colspan="2" class="l" align="center"></td>
					...
					<tr class="highs" style="">
						<td class="l">4. ระบบไฟฟ้า ควบคุมห้องเย็น <strong><u><?php echo $firefa;?> </u></strong> <span style="font-size:14px;"></span> ชุดใหม่ </td>
						<td colspan="2" class="l" align="center"><?php echo $qtyhp; ?> ชุด</td>
						<td class="l" align="center"></td>
						<td class="l" align="right"></td>
					</tr>
					...
					<tr class="highs" style="">
						<td class="l">&nbsp;&nbsp;&nbsp; - พร้อมระบบความปลอดภัย <strong><u>ชุดใหม่</u></strong></td>
						<td colspan="2" class="l"></td>
						<td class="l" align="center"></td>
						<td class="l" align="right"></td>
					</tr>
			...
			<div id="amount" class="amounts" style="clear: both; margin-top: 5px;">
				<div style="width: 50%; float:left;">
					<table style="width: 100%; border-collapse: collapse;">
						<tr>
        ...
        <div class="subpage">
           ...
           <div id="cover_header">
			...
			<div class="container">
				<div class="row">
					<div class="col1">
						<span class="topic">อุปกรณ์ไฟฟ้าชุดใหม่ ประกอบด้วย</span><br>
        ...
        <div class="subpage">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col2">
						<span class="topic">ฉนวนโฟมผนังห้องเย็นแผ่นใหม่</span><br>
