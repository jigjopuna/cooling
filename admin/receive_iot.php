        ...
        <div class="subpage">
			...
			<div id="detail" style="/*background-color: olive;*/ height:300px; float: none; margin-top: 15px;">
				<table style="width: 100%;">
					...
					<tr>
						<td>1</td>
						<td>ระบบเช็คอุณหภูมิและสถานะการทำงานของเครื่องทำความเย็น ออนไลน์ IDCAM </td>
						<td align='right'>1</td>
						<td align='center'>ตัว</td>
						<td align='center'>28,037.38 </td>
						<td align='center'>28,037.38 </td>  
					</tr>
					
					<tr>
						<td>2</td>
						<td>ค่าบริการ Could Service และเจ้าหน้าที่ดูแลระบบห้องเย็น ฟรี 1 ปี แรก</td>
						<td align='right'></td>
						<td align='center'></td>
						<td align='center'></td>
						<td align='center'><s>10,000.00</s></td>  
					</tr>
					
					<tr>
						<td>3</td>
						<td>ค่าบริการติดตั้งระบบ</td>
						<td align='right'></td>
						<td align='center'></td>
						<td align='center'></td>
						<td align='center'></td>  
			...
			<div id="summary" style="/*background-color:red;*/ overflow:hidden; /*height: 200px;*/">
				<div id="pricetext" style="float:left; width:65%; /*background-color:brown;*/">
					...
					<p style="line-height:150%;">
						...
						*  ธนาคารกรุงเทพ  บจ. พระลักษณ์ไทย เลขที่บัญชี 275-4-64428-0<br>
					</p>
