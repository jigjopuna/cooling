...
<head>
	...
	<title>RECEIPT/TAX INVOICE (ORIGINAL)</title>
...
<?php 
	...
	if($row_order['o_vat']==1){
		...
		$price = $vatprice * 1.07;
		$bill_head = 'RECEIPT/TAX INVOICE (ORIGINAL)';
	}else{
		$price = $vatprice;
		$bill_head = 'INVOICE';
	}
    ...
    <div class="page">
        <div class="subpage">
			<div id="corp_addr_ini">
				<?php 
					if($corp_addr == 1){
						require_once('../include/tcl_addr_eng.php');
					}else{
			...
			<?php include('../include/billdetail_eng.php'); ?>
			...
			<div id="detail" style="/*background-color: olive;*/ height:300px; float: none; margin-top: 15px;">
				<table>
					<tr>
						...
						<td style="width:7%;" align='center'>Qty</td>
						<td style="width:12%;" align='center'>Unit</td>
						<td style="width:12%;" align='center'>Price</td>
						<td style="width:12%;" align='center'>Amount</td>
					</tr>
					<tr>
						<td colspan="6"> <hr> </td>
					</tr>
					...
					<tr>
						<td>1.</td>
						<td>Cold Storage Room Temp <?php echo $row_order['o_temp']?>C<sup>o</sup>  Size <?php echo $row_order['o_width'].' x '.$row_order['o_size'].' x '.$row_order['o_high'];?> Meter (Period 2)</td>
						<td align='right'>1</td>
					...
					<tr>
						<td>2.</td>
						<td>Cold Storage Room Temp -20Co Size 2.4 x 4.0 x 2.4 Meter (Period 2)</td>
						<td align='right'>1</td>
						<td align='center'>Room</td>
						<td align='center'></td>
						<td align='center'></td>  
			...
			<div id="summary" style="/*background-color:red;*/ overflow:hidden; /*height: 200px;*/">
				<div id="pricetext" style="float:left; width:65%; /*background-color:brown;*/">
					...
					<p style="line-height:150%;">
						* Kasikorn Bank Account (Savings Account)<br>
						* Chookiad Tenumpai Account No.  <span style="text-decoration: underline; font-weight: bold;">855-2-05499-8</span><br>
				...
				<div id="signature">
					...
					<div class="sign">Collector ...........................</div>
					<div class="sign">Customer .........................</div>
				...
				<div id="custname">
					<div class="sign1">&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)</div>
					<div class="sign1">&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)</div>
					<div class="sign1">&nbsp;&nbsp;&nbsp;(&nbsp;&nbsp;<?php if($corp_addr == 1){ echo 'Chookiad Tenumpai'; }else{ echo 'ไพฑูรย์ เกตุแก้ว';}	?>&nbsp;&nbsp;)</div>		
				</div>
			</div>
