        ...
        <div class="subpage">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col2">
						<div style="width: 300px; height:280px; background: orange;"></div>
					</div>
				</div> <!--end row-->
				...
				<div class="row">
					<div class="col1">
						...
						<p><span class="intopic">ตัวยึดท่อทองแดง :</span> ก้ามปูและ</p>
        ...
        <div class="subpage">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col4"><span class="topic">ฮีทเตอร์สำหรับละลายน้ำแข็ง (Defrost)</span><br>
			...
			<div class="container">
				<div class="row">
					<div class="col1">
						...
						<p><span class="intopic">คุณสมบัติ :</span> ensity 38-40 kg/m3 เหล็ก  0.55 เมตร</p>
				...
				<div class="row">
					...
					<div class="col4"><span class="topic">ประตูห้องเย็น</span><br>
