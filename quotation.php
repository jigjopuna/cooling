        ...
        <div class="subpage">
			...
			<div id="contect_detail" style="margin-top:85px;">
				<div class="cust" style="float:left; width:65%; line-height:18px;">
					<span>ชื่อลูกค้า : <a href="th/register/register.php">ใส่ข้อมูลชื่อ / บริษัท</a></span> <br>
			...
			<div id="product_price" style="margin-top:105px; clear:both">
				<table style="width: 100%; border: solid black 1px;  border-collapse: collapse;">
					...
					<tr>
						...
						<td colspan="2" class="l" align="center"><?php echo number_format($var_florom, 2, '.', ',') ." ตร.ม.";?></td>
					...
					<tr>
						<td>7. <?php echo $row_pressure['catr_name'];?></td> 
						<td colspan="2" class="l" align="center"><?php echo $count_pressure." ตัว"?></td>
						<td class="l" align="right"></td>
						<td class="l" align="right"></td>
					...
					<tr>
						<td>8. <?php echo $row_door['catr_name'];?></?></td>
					...
					<tr>
						<td>9. <?php echo $row_man['catr_name'];?></?></td>
						<td colspan="2" class="l" align="center">1</td>
					...
					<tr>
						<td>10. <?php echo $row_gerneral['catr_name'];?></?></td>
						<td colspan="2" class="l" align="center"><?php echo number_format($var_room, 2, '.', ',')." ตร.ม.";?></td>
