<?php session_start(); 
	  ...
	  $sql_combrand = "SELECT b.brand_name, a.jumnun FROM tb_brand b JOIN (SELECT t_cate cate , COUNT(t_id) jumnun FROM tb_tools WHERE t_type = 11 AND t_subtype = 2 GROUP BY t_cate) a ON b.brand_id = a.cate ";
	  $result_combrand = mysql_query($sql_combrand);
	  $num_combrand = mysql_num_rows($result_combrand);
	  //SELECT t.t_name, b.brand_name, t.t_cost  FROM tb_tools t JOIN tb_brand b ON t.t_cate = b.brand_id WHERE t.t_type = 11 AND t_subtype = 2
	  //SELECT b.brand_name, a.jumnun FROM tb_brand b JOIN (SELECT t_cate cate , COUNT(t_id) jumnun FROM tb_tools WHERE t_type = 11 AND t_subtype = 2 GROUP BY t_cate) a ON b.brand_id = a.cate 
?>    
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<meta name="keywords" content="คอมเพรสเซอร์ห้องเย็น, COPELAND, BITZER" />
    <meta name="description" content="คอมเพรสเซอร์ห้องเย็นราคาถูก คุณภาพดี Copland Bitzer ห้องเย็นฟรีสอุณหภูมิติดลบ ห้องชิวอุณหภูมิชิว รู้ราคาทันที มีของพร้อมส่ง">
    <meta name="author" content="topcooling">
	<meta property="og:url" content="https://topcooling.net/shop/product/compressor.php" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="ขายคอมเพรสเซอร์ห้องเย็น Copeland, Bitzer" />
	<meta property="og:description" content="คอมเพรสเซอร์ห้องเย็นราคาถูก คุณภาพดี Copland Bitzer ห้องเย็นฟรีสอุณหภูมิติดลบ ห้องชิวอุณหภูมิชิว รู้ราคาทันที มีของพร้อมส่ง" />
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						<?php 
							for($i=1; $i<=$num_combrand; $i++){
							$row_combrand = mysql_fetch_array($result_combrand);
						?>
						<div class="col-sm-6 col-md-6 col-lg-3 p-b-50 2colmobile" style=" width:50%; float:left;">
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<a href="https://topcooling.net/shop/product/room_detail.php?cate=<?php echo $row_combrand['catr_id']; ?>">
										<img src="https://topcooling.net/shop/images/category/room/<?php echo $row_combrand['catr_id']; ?>.jpg" alt="ห้องเย็น <?php echo $row_catroom['catr_name']; ?>">
								...
								<div class="block2-txt p-t-20">
									<a href="https://topcooling.net/shop/product/room_detail.php?cate=<?php echo $row_combrand['catr_id']; ?>" class="block2-name dis-block s-text3 p-b-5">
										<?php echo $row_combrand['catr_name']; ?>
