<?php session_start(); 
	 ...
	 /* $sql = "SELECT * FROM tb_categoryroom c JOIN tb_productroom p ON c.catr_id = p.pr_cate";
	  $result = mysql_query($sql);
	  $num = mysql_num_rows($result);
	  
	  $sql_cat ="SELECT * FROM tb_categoryroom ORDER BY catr_id";
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="flex-sb-m flex-w p-b-35">
						...
						<span class="s-text8 p-t-5 p-b-5">
							มีทั้งหมด 8 หมวดหมู่ <!--Showing 1–12 of 16 results-->
						</span>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=1" class="block2-name dis-block s-text3 p-b-5">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=5" class="block2-name dis-block s-text3 p-b-5">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=5&subcate=2" class="block2-name dis-block s-text3 p-b-5">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=6" class="block2-name dis-block s-text3 p-b-5">
										ม่านห้องเย็น
									</a>
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=3" class="block2-name dis-block s-text3 p-b-5">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=8" class="block2-name dis-block s-text3 p-b-5">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product/room_detail.php?cate=10" class="block2-name dis-block s-text3 p-b-5">
