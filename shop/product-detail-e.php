...
<head>
	...
	<meta property="og:image" content="images/product/electric/<?php echo $p_image;?>/5.jpg"/>
...
<body class="animsition">
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/product/electric/<?php echo $p_image;?>/11.jpg">
							<div class="wrap-pic-w">
								<img src="images/product/electric/<?php echo $p_image;?>/1.jpg" alt="">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/product/electric/<?php echo $p_image;?>/22.jpg">
							<div class="wrap-pic-w">
								<img src="images/product/electric/<?php echo $p_image;?>/2.jpg" alt="IMG-PRODUCT">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/product/electric/<?php echo $p_image;?>/33.jpg">
							<div class="wrap-pic-w">
								<img src="images/product/electric/<?php echo $p_image;?>/3.jpg" alt="IMG-PRODUCT">
							</div>
						</div>
					</div>
				</div>
	...
	<section class="bgwhite p-t-60">
		<?php  include('images/product/electric/'.$p_image.'/'.$p_image.'.php');?>
	</section>
